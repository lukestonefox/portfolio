        ...
        <header className="justify-between w-full lg:h-full">
            <div className="flex flex-col justify-between h-full gap-y-4">
                <div className='flex flex-col gap-y-4'>
                    <a href="#intro" className='text-2xl font-semibold text-nowrap md:text-4xl xl:text-7xl'>Lucas Fox</a>
                    <p className='text-xl font-semibold text-nowrap'>Fullstack Software Engineer</p>
                    <nav>
                        <ul className="flex flex-row gap-x-4">
                            <li><a className='hover:underline' href="#intro">About</a></li>
