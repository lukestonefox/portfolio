            ...
            <div className="flex items-center justify-center w-screen h-screen">
                <div className="flex flex-col w-full px-32">
                    ...
                    <div className="grid w-full grid-cols-12 px-4 py-2 font-semibold">
                        ...
                        <p className="hidden lg:block lg:col-span-6 xl:col-span-4">Technologies</p>
                        ...
                        {ArchiveData.map((project, index) => (
                            <>
                                ...
                                {project.github && <a target="_blank" className="hidden col-span-2 duration-200 hover:text-gray-600" href={project.github} title="GitHub"><Github /></a>}
                            </div>
